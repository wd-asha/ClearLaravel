...
class SubscriberController extends Controller
{
    ...
    public function subscribe()
    {
        ...
        $notification = array(
            'message' => 'Новый подписчик создан',
            'alert-type' => 'success'
        );
    ...
    /*    Show form email   */
    /* -------------------- */
    public function formMail($userEmail)
    {
        return view('admin.subscriber.mail', compact('userEmail'));
    }
    /* end show email */
    ...
    public function sendMail(Request $request)
    {
        ...
        /* to page with list subscribers */
        return view('admin.subscriber.index', compact('subscribers', 'trashed'))->with($notification);
    }
