...
<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href="{{ URL('/') }}">Clear</a></div>
    ...
    <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
                ...
                <span class="menu-item-label">Товары</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div>
        </a>

        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.products') }}" class="nav-link">Все товары</a></li>
            <li class="nav-item"><a href="{{ route('product.create') }}" class="nav-link">Новый товар</a></li>
        </ul>
