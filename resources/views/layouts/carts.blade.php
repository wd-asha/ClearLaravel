...
<div class="bg-nav">
    <div class="navigation">
        ...
        <div class="cabinet">
            ...
            @endauth
            <div class="cabinet-cart" style="background-color: rgba(0, 93, 105, 1);">
                <a href="{{ route('carts') }}">
...
<div class="bg-footer" style="flex: 0 0 auto">
    <div class="footer">
...
<script>
    $(document).ready(function(){
        let $pmc = $('.payment_method_cod');
        let $pma = $('.payment_method_all');
        let $fc = $('.form-carts');
        let $p = $('.payments');
        $p.slideUp();
