...
@section('content')
    ...
    <div class="card pd-20 pd-sm-40 mg-t-50">
        <h6 class="card-body-title">Поступившее заказы</h6>
        <p class="mg-b-20 mg-sm-b-30">Всего новых заказов: {{ $orders->total() }}<span style="float: right"></span></p>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered mg-b-0 mb-5">
                ...
                <tr>
                    ...
                    <th class="wd-5p">Дата и врямя доставки</th>
